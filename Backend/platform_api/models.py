...
class PredefinedRequest(models.Model):
    """Template/predefined requests that clients can use"""
    title = models.CharField(max_length=255)
    ...
    estimated_budget_min = models.DecimalField(
        ...
        blank=True,
        null=True,
        help_text="Estimated minimum budget"
    )
    estimated_budget_max = models.DecimalField(
        ...
        blank=True,
        null=True,
        help_text="Estimated maximum budget"
    )
