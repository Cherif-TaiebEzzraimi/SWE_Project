...
//         <h1 className={styles.title}>Sign up as an individual client</h1>
//         {apiError && (
...
// export default SignupClientIndividual;
...
const SignupClientIndividual: React.FC = () => {
  ...
  const validateForm = (): boolean => {
    ...
    else if (!/^\d{10}$/.test(formData.phone_number)) newErrors.phone_number = 'Phone number must be exactly 10 digits';
    ...
    <div className={styles.container}>
      <header className={styles.header}>
        <div className={styles.headerContent}>
          ...
          <div className={styles.headerLinks}>
            <span className={styles.headerText}>Here to find work?</span>
            <button onClick={() => navigate('/signup/freelancer')} className={styles.headerLink}>
              Join as a Freelancer
            </button>
          </div>
        </div>
      ...
      <div className={styles.content}>
        <h1 className={styles.title}>Sign up as an individual client</h1>
        {apiError && <div className={styles.errorAlert}><span>{apiError}</span></div>}
        <form onSubmit={handleSubmit} className={styles.form} noValidate>
          <div className={styles.row}>
            <div className={styles.formGroup}>
              <Input
          ...
          <div className={styles.row}>
            <div className={styles.formGroup}>
              ...
              <WilayaDropdown
                value={formData.wilaya}
                onChange={(val) =>
                  handleChange({ target: { name: 'wilaya', value: typeof val === 'string' ? val : '' } } as any)
                }
                error={errors.wilaya}
                disabled={loading}
              />
          ...
          <button type="submit" disabled={loading || !agreedToTerms} className={styles.submitButton}>
            {loading ? 'Creating account...' : 'Create my account'}
          </button>
          <p className={styles.loginLink}>
            Already have an account?{' '}
