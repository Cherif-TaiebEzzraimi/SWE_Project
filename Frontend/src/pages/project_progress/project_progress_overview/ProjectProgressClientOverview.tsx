...
export default function ProjectProgressClientOverview({
  ...
  const handleSubmitFiles = async () => {
    const uploaded: MediaFile[] = files.map(f => ({
      id: f.id,
      file_url: 'mock',
      file_type: f.type,
      file_name: f.name,
  ...
  return (
    <div className={styles.pageContainer}>
      ...
      <div className={styles.tabContent}>
        <ProjectCard
          projectTitle="E-Commerce Website Redesign – Bloom & Co."
          projectDescription="Design and develop a modern, visually compelling e-commerce platform for our boutique floral business..."
          submittedOn="October 26, 2023"
          budget="$2,500"
          userType="freelancer"
          userName="Sarah Jenkins"
